    ...
    exports.lpCoreI18n = function(lpCoreUtils, $translateProvider, lpCoreI18nUtils, tmhDynamicLocaleProvider) {
        ...
        this.$get = function($filter, lpCoreI18nLoader, $translate, tmhDynamicLocale, lpCoreBus) {
            ...
            return {
                 ...
                 * @param   {Object} interpolateParams  Object with params.
                 * @param   {String} interpolationId  The id of the interpolation to use.
                 * @param   {String} forceLanguage  A language to be used instead of the current language
                 * @returns {String}
                 */
                instant: function(string, interpolateParams, interpolationId, forceLanguage) {
                    return $translate.instant(string, interpolateParams, interpolationId, forceLanguage);
                }
